    ...
    public static void main(String[] args) {
        ...
        if(age>=18)
        {
            ...
            if(choice==1)
            {
                ...
                if(years >=5)
                {
                    System.out.println("The Candidate can apply for a Aadhar Card");
                    System.out.println("Age = "+age+" Indian = "+choice+" years = "+years);
                }
                else
                {
                    System.out.println("The Candidate cannot apply for a Aadhar Card ");
                    System.out.println("Age = "+age+"Indian = "+choice+"years = "+years);
                }
            }
            else
            {
                System.out.println("No Aadhar  Card for Non Indian");
            }
        }
        else
        {
